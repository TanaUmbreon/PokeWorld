...
namespace PokeWorld.Test.Statistics
{
    ...
    public class PokemonTest
    {
        ...
        {
            // ダネちゃんLv.1爆誕！
            var fushiLv1 = new Pokemon(Species.Bulbasaur, new Level(1));
            ...
            // ダネちゃんLv.2爆誕！
            var fushiLv2 = new Pokemon(Species.Bulbasaur, new Level(2));
            ...
            // ダネちゃんLv.99爆誕！
            var fushiLv99 = new Pokemon(Species.Bulbasaur, new Level(99));
            ...
            // ダネちゃんLv.100爆誕！
            var fushiLv100 = new Pokemon(Species.Bulbasaur, new Level(100));
